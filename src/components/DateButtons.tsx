...
const DateButtons = ({onDateChange}:{onDateChange:any}) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-around items-center mt-1 space-y-2 sm:space-y-0 sm:space-x-2">
      <button
        onClick={() => toggleButton('weekBtn')}
        className={`selectable-button ${selectedButton === 'weekBtn'
      ...
      <button
        ...
        className={`selectable-button ${selectedButton === 'monthBtn'
          ? 'bg-black text-white hover:text-white hover:bg-black'
          : 'bg-transparent text-gray-500 hover:text-black'
      ...
      <button
        ...
        className={`selectable-button ${selectedButton === 'threeMonthsBtn'
          ? 'bg-black text-white hover:text-white hover:bg-black'
          : 'bg-transparent text-gray-500 hover:text-black'
